...
- (void)createBtns {
    ...
    [shareBtn setTitle:@"拍          照" forState:UIControlStateNormal];
    ...
    saveBtn.tag = 2;
    [saveBtn setTitle:@"选 取 照 片" forState:UIControlStateNormal];
...
- (void)clickBFBtns:(id)sender {
    ...
    [self.delegate clickPickerWithTag:btn.tag];
}
